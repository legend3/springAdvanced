 ...
 * 顺序:  容器bean    postProcessBeforeInitialization拦截实例化的各bean
 *
 * 声明，指生成对象不赋值的过程。
 * 初始化，是给对象赋值的过程。
...
public class MyBeanPostProcessor implements BeanPostProcessor {
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        ...
        if(bean instanceof Student){//如果拦截到Student实例
            System.out.println("MyBeanPostProcessor拦截器初始化...");
            Student stu = (Student)bean;//bean: "stu"
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        if(bean instanceof Student) {
            ...
            System.out.println("MyBeanPostProcessor...销毁..");
        }
//        System.out.println("销毁:"+beanName+":"+bean);
            return bean;
    }
